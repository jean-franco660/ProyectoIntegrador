import 'package:gestion_asistencia/util/UrlApi.dart';
import 'package:gestion_asistencia/models/AsistenciaxModelo.dart';
import 'package:gestion_asistencia/models/GenericModelo.dart';
...
abstract class AsistenciaxApi {
  ...
  Future<List<AsistenciaxRespModelo>> getAsistenciapa(
      @Header("Authorization") String token);

  @POST("/asis/asistenciax/crear")
  Future<AsistenciaxModelo> createAsistenciapa(
      @Header("Authorization") String token,
      @Body() AsistenciaxModelo asistenciapa);
  ...
  Future<AsistenciaxModelo> updateAsistenciapa(
      @Header("Authorization") String token,
      @Path("id") int id,
      @Body() AsistenciaxModelo asistenciapp);
}
